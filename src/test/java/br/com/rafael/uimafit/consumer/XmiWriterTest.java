...
public class XmiWriterTest {
	...
	public void Test() throws Exception {
		...
		AnalysisEngineDescription xmiWriter = createEngineDescription(XmiWriter.class, XmiWriter.PARAM_OUTPUT_DIRECTORY, testFolder.getRoot());
		
		SimplePipeline.runPipeline(documentReader, xmiWriter);
		
		assertTrue(new File(testFolder.getRoot(), "SimpleText.txt.xmi").exists());
